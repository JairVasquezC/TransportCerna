...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('marcas.create')}}">
            <button type="button" class="btn btn-danger">Añadir nuevo registro</button>
        </a>
    </div>
    @endcan
            ...
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>ABC-123</td>
                        <td>
                            <span class="badge rounded-pill text-bg-success" onclick="cambiarEstado(this)">activo</span>
                        </td>
                        <td>
